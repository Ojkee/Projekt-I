...
CASES_PARSER_INVALID_EXPR: list[Case] = [
    ...
    Case(
        ...
        input="5 *",
        expected=[wrap(ParserErrorUserMsg.missing_rhs_in_expr("5", "*"))],
    ),
    Case(
        name="Missing right operand after divide",
        input="a /",
        expected=[wrap(ParserErrorUserMsg.missing_rhs_in_expr("a", "/"))],
    ),
    Case(
    ...
    Case(
        ...
        input="2 + 3)",
        expected=[wrap(ParserErrorUserMsg.extra_input_in_line(")"))],
    ),
    Case(
    ...
    Case(
        ...
        input="(",
        expected=[wrap(ParserErrorUserMsg.unexpected_eof())],
    ),
    Case(
    ...
    Case(
        ...
        input="abc def",
        expected=[wrap(ParserErrorUserMsg.extra_input_in_line("d"))],
    ),
    Case(
