...
CASES_PARSER_INVALID_FORMULA: list[Case] = [
    Case(
        name="Bang alone",
        input="!",
        expected=[wrap_stmt(ParserErrorUserMsg.no_formula_name())],
    ),
    Case(
    ...
    Case(
        ...
        input="!func x, 3 *",
        expected=[wrap_stmt(ParserErrorUserMsg.missing_rhs_in_expr("3", "*"))],
    ),
    Case(
    ...
    Case(
        ...
        input="!func x + 2)",
        expected=[wrap_stmt(ParserErrorUserMsg.missing_comma_in_formula())],
    ),
    Case(
    ...
    Case(
        ...
        expected=[wrap_stmt(ParserErrorUserMsg.missing_rhs_in_expr("e", "+"))],
    ),
    Case(
        ...
        expected=[
            AnyNonErrorStatement(),
            wrap_stmt(ParserErrorUserMsg.no_formula_name()),
        ],
    ),
    Case(
    ...
    Case(
        ...
        expected=[
            AnyNonErrorStatement(),
            wrap_stmt(ParserErrorUserMsg.illegal_str("@")),
        ],
    ),
]
