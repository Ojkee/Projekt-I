...
CASES_CONVERT_ADDITION = [
    ...
    Case(
        ...
        FlattenAdd([FlattenSymbol("a"), FlattenSymbol("b"), FlattenSymbol("c"), FlattenSymbol("d")]),
    ),
]
...
CASES_CONVERT_MULTIPLICATION = [
    ...
    Case(
        ...
        FlattenMul([FlattenSymbol("x"), FlattenSymbol("y"), FlattenSymbol("z"), FlattenSymbol("w")]),
    ),
]
...
CASES_CONVERT_ADVANCED = [
    Case(
        ...
        FlattenAdd([FlattenMul([FlattenSymbol("a"), FlattenSymbol("b")]), FlattenSymbol("c")]),
    ),
    Case(
        "Multiplication and addition",
        Mul(Add(Symbol("x"), Symbol("y")), Symbol("z")),
        FlattenMul([FlattenAdd([FlattenSymbol("x"), FlattenSymbol("y")]), FlattenSymbol("z")]),
    ),
    Case(
        "Complex nested expression",
        Add(Mul(Symbol("a"), Add(Symbol("b"), Symbol("c"))), Symbol("d")),
        FlattenAdd([
            FlattenMul([FlattenSymbol("a"), FlattenAdd([FlattenSymbol("b"), FlattenSymbol("c")])]),
            FlattenSymbol("d")
        ]),
    ),
    Case(
        "Complex nested expression with multiple levels",
        Add(Symbol("x"), Add(Mul(Symbol("y"), Symbol("z")), Add(Symbol("w"), Mul(Symbol("u"), Symbol("v"))))),
        FlattenAdd([
            FlattenSymbol("x"),
